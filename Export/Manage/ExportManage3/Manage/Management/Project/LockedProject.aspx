<%@ Page Title="" Language="VB" MasterPageFile="~/Plain.master" AutoEventWireup="false" CodeFile="LockedProject.aspx.vb" Inherits="Management.Project.ManagementProjectLockedProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:SqlDataSource ID="ProjectSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
        SelectCommand="SELECT [ProjectID], [LCID], [JobTitle], [ProjectTitle], [StartDate], [EndDate], [Description], [SpecialNotes], [Address], [DatePosted] FROM [LockedProject]"  >
        <DeleteParameters>
