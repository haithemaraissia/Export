                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="ClosedProjectGridView" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="CustomerID" DataSourceID="CustomerGenerals2SqlDataSource">
                                    <Columns>
                                ...
                                <asp:SqlDataSource ID="CustomerGenerals2SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
