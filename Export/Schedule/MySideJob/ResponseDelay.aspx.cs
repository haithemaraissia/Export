            ...
            case Message.NewOption:
                {
                    ...
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                            Server.MapPath("~/EmailTemplates/CustomerNewOption.aspx"), Message.NewOption, "CUS", PosterID);
                    }
                    if (PosterRole == "PRO")
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/ProfessionalNewOption.aspx"), Message.NewOption, "PRO", PosterID);
                    }
                }
                break;
            ...
            case Message.NewOpportunity:
                {
                    ...
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                            Server.MapPath("~/EmailTemplates/CustomerNewOpportunity .aspx"), Message.NewOpportunity, id: PosterID);
                    }
                    if (PosterRole == "PRO")
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/ProfessionalNewOpportunity .aspx"), Message.NewOpportunity, id: PosterID);
                    }
                }
                break;
            ...
            case Message.Refund:
                {
                    ...
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/Customer/CustomerRefund.aspx"), Message.Refund, id: PosterID, pdtid: PDTID);
                    }
                    if (PosterRole == "PRO")
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/Professional/ProfessionalRefund.aspx"), Message.Refund, id: PosterID, pdtid: PDTID);
                    }
                }
                break;
            ...
            case Message.Blocked:
                {
                    ...
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/CustomerBlocked.aspx"), Message.Blocked, id: PosterID);
                    }
                    if (PosterRole == "PRO")
                    {
                        SendEmail(PosterEmailAddress, PosterUsername, PosterLCID, t1.ReminderLevel,
                               Server.MapPath("~/EmailTemplates/ProfessionalBlocked.aspx"), Message.Blocked, id: PosterID);
                    }
                }
                break;
        }
        ...
        Message messageType, string role = "", int id = 0, int pdtid = 0)
    {
        ...
        switch (messageType)
        {
            case Message.Notification:
                ...
                url = templateUrl + "?&l=" + ScheduleUtility.GetLanguage(lcid) + "&prid=" + ProjectID + "&usn=" + userName + "&bidder=" + BidderUsername + "&rem=" + reminderLevel;
                break;
