<%@ Page Title="" Language="C#" MasterPageFile="~/Plain.master" AutoEventWireup="true" CodeFile="Test.aspx.cs" Inherits="Management_Advertise_Test" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    
    Use the same database for the advertiser
    queried by role
    use the admin password or username to get into this
     <asp:GridView   
             ID="GridView1"   
             runat="server"  
             AllowPaging="True"  
             ...
             PageSize="10" CellPadding="4" AutoGenerateColumns="false" 
           ...
           <Columns>
            <asp:TemplateField HeaderText="Name">
             ...
             <asp:TemplateField HeaderText="Picture1">
                <ItemTemplate>
                    <asp:Image ID="ProfilePicture" runat="server" ImageUrl='<%#Eval("Picture1").ToString()%>' Height="50px" Width="50px" />
                </ItemTemplate>
            </asp:TemplateField>
